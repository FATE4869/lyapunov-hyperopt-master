...
def main():
    ...
    # plot the eig space of M
    # eig_values, _ = la.eig(tl_learner.M)
    ...
    #     if i==0:
    #         zt = tl_learner.training_stats[i]['inputs'][:, :-1]
    #         # print(z[:, :-1].shape)
    #     else:
    #         zt = np.concatenate((zt, tl_learner.training_stats[i]['inputs'][:, :-1]), 1)
    # # print(z.shape)
    # # print(tl_dataloader.train_dataset.shape)
    # plt.figure()
    ...
    # zpt = tl_learner.testing_stats[training_epochs-1]['inputs'][:, 1:]
    # print(zpt.shape)
    # print(zpt)
    # print(tl_dataloader.test_dataset.shape)
    #
    # plt.figure()
    ...
    # plt.title("Testing")
    # plt.show()
    # val_loss = np.sum(np.absolute(tl_learner.dataloader.test_dataset - zpt)) / len(tl_learner.dataloader.test_simtime)
    # print(val_loss)
